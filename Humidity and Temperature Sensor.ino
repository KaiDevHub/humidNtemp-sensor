...
String apiKey = "108H88RDRO0TU7RD";     //  Enter your Write API key here

const char* server = "api.thingspeak.com";

const char *ssid =  "Super";     // Enter your WiFi Name

const char *pass =  "iambatman"; // Enter your WiFi Password
